...
void fnSendKeyStroke(uint8_t data_in){
  ...
  switch(data_in){
    case 0:
     TrinketHidCombo.pressKey(KEYCODE_LEFT_CONTROL, KEYCODE_C);
     break;
    case 1:
     TrinketHidCombo.typeChar(KEYCODE_HOME);
     break;
    case 2:
     TrinketHidCombo.pressKey(KEYCODE_MOD_LEFT_GUI, KEYCODE_MOD_LEFT_SHIFT, KEYCODE_S);
     break;
    case 3:
     ...
     break;
    case 4:
     TrinketHidCombo.pressKey(KEYCODE_LEFT_CONTROL, KEYCODE_V);
     break;
    case 5:
     TrinketHidCombo.typeChar(KEYCODE_END);
     break;
    case 6:
     TrinketHidCombo.pressKey(KEYCODE_LEFT_CONTROL, KEYCODE_L);
     break;
    case 7:
     TrinketHidCombo.pressKey(KEYCODE_LEFT_CONTROL, KEYCODE_MOD_LEFT_ALT, KEYCODE_DELETE);
     break;
  }
  TrinketHidCombo.pressKey(0, 0);
  TrinketHidCombo.poll();
